...
$modx->log(modX::LOG_LEVEL_DEBUG, 'Prospect ID: '.$prospectId);
...
if($prospectId) {
    ...
    if($prospect = $modx->getObject('modUser',$prospectId)){
    	$modx->log(modX::LOG_LEVEL_DEBUG, 'Prospect: '.$prospect->get('username').' class key:'.$prospect->get('class_key'));
    	if($prospect->get('class_key') == 'wxProspect') {
	    	if($getWebinarData) {
